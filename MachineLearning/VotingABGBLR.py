############################################################
# Voting Classifier taking into                            #
# account Ada Boosting and Gradient Boosting Classifier    #
...
def popular(dir,t,o,l,m,train,k,ytBin,twBin):
        ...
        clf = VotingClassifier(estimators=[('abdt', clf1), ('gbdt', clf2),('lr', clf3)], voting='soft')
